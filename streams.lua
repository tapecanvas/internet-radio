-- add streams with the following formatting:
-- {name = "", address = ""},
-- to hide a stream from your station list add `--` before the appropriate entry below

return {
    {name = "SomaFM - Lush", address = "http://ice1.somafm.com/lush-128-mp3"},
    {name = "SomaFM - Tiki Time", address = "http://ice1.somafm.com/tikitime-128-mp3"},
    ...
    {name = "SomaFM - SF 10-33", address = "https://ice1.somafm.com/sf1033-128-mp3"},
-- add streams  {name = "", address = ""},
}
